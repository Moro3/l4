...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Laravel4-lang/ru/reminders.php at master · caouecs/Laravel4-lang · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars0.githubusercontent.com/u/447849?s=400" property="og:image" /><meta content="caouecs/Laravel4-lang" property="og:title" /><meta content="https://github.com/caouecs/Laravel4-lang" property="og:url" /><meta content="Laravel4-lang - List of 37 languages for Laravel4" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="6DFC0843:3D64:27E7070:53871980" name="octolytics-dimension-request_id" />
...
<meta content="FNHg22itPWd3vVvpBZeDblj2ep1HdlmL18zlxQ6hmyRIBJ5i8XJCraDL5Wj8WKkMdPSfDWfLg/UoCifMC1Ou+Q==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fcaouecs%2FLaravel4-lang%2Fblob%2Fmaster%2Fru%2Freminders.php">Sign in</a>
    </div>
...
<a href="/caouecs/Laravel4-lang/blob/96f9e020f803962e4e379303e3722533de7b4882/ru/reminders.php" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:755eac37be520211b7b1cc2c438d27f0 -->
...
<div class="select-menu js-menu-container js-select-menu" >
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/blob/gh-pages/ru/reminders.php"
                 data-name="gh-pages"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/blob/master/ru/reminders.php"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.12.0/ru/reminders.php"
                 data-name="0.12.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.11.0/ru/reminders.php"
                 data-name="0.11.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.10.0/ru/reminders.php"
                 data-name="0.10.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.9.0/ru/reminders.php"
                 data-name="0.9.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.8.0/ru/reminders.php"
                 data-name="0.8.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.7.1/ru/reminders.php"
                 data-name="0.7.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.7.0/ru/reminders.php"
                 data-name="0.7.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.6.1/ru/reminders.php"
                 data-name="0.6.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.6.0/ru/reminders.php"
                 data-name="0.6.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.5.0/ru/reminders.php"
                 data-name="0.5.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.4.4/ru/reminders.php"
                 data-name="0.4.4"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.4.3/ru/reminders.php"
                 data-name="0.4.3"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.4.2/ru/reminders.php"
                 data-name="0.4.2"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.4.1/ru/reminders.php"
                 data-name="0.4.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.4.0/ru/reminders.php"
                 data-name="0.4.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.3.0/ru/reminders.php"
                 data-name="0.3.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.2.2/ru/reminders.php"
                 data-name="0.2.2"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.2.1/ru/reminders.php"
                 data-name="0.2.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.2.0/ru/reminders.php"
                 data-name="0.2.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/caouecs/Laravel4-lang/tree/0.1.0/ru/reminders.php"
                 data-name="0.1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
  ...
  <div class="breadcrumb">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/caouecs/Laravel4-lang" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">Laravel4-lang</span></a></span></span><span class="separator"> / </span><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/caouecs/Laravel4-lang/tree/master/ru" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">ru</span></a></span><span class="separator"> / </span><strong class="final-path">reminders.php</strong> <button aria-label="copy to clipboard" class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="ru/reminders.php" data-copied-hint="copied!" type="button"><span class="octicon octicon-clippy"></span></button>
  </div>
</div>


  <div class="commit file-history-tease">
      <img alt="Evgeny" class="main-avatar js-avatar" data-user="3984076" height="24" src="https://avatars1.githubusercontent.com/u/3984076?s=140" width="24" />
      <span class="author"><a href="/EvgenyKovalev" rel="contributor">EvgenyKovalev</a></span>
      <time datetime="2013-11-21T14:57:06+04:00" is="relative-time" title-format="%Y-%m-%d %H:%M:%S %z" title="2013-11-21 14:57:06 +0400">November 21, 2013</time>
      <div class="commit-title">
          <a href="/caouecs/Laravel4-lang/commit/f16b9a363ed93a1b9f6734a0f83a00f87a0be276" class="message" data-pjax="true" title="Laravel 4.1 - ready language fix.">Laravel 4.1 - ready language fix.</a>
      </div>

    <div class="participation">
      <p class="quickstat"><a href="#blob_contributors_box" rel="facebox"><strong>2</strong>  contributors</a></p>
          <a class="avatar tooltipped tooltipped-s" aria-label="EvgenyKovalev" href="/caouecs/Laravel4-lang/commits/master/ru/reminders.php?author=EvgenyKovalev"><img alt="Evgeny" class=" js-avatar" data-user="3984076" height="20" src="https://avatars1.githubusercontent.com/u/3984076?s=140" width="20" /></a>
    <a class="avatar tooltipped tooltipped-s" aria-label="caouecs" href="/caouecs/Laravel4-lang/commits/master/ru/reminders.php?author=caouecs"><img alt="Fred Delrieu" class=" js-avatar" data-user="447849" height="20" src="https://avatars3.githubusercontent.com/u/447849?s=140" width="20" /></a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img alt="Evgeny" class=" js-avatar" data-user="3984076" height="24" src="https://avatars1.githubusercontent.com/u/3984076?s=140" width="24" />
            <a href="/EvgenyKovalev">EvgenyKovalev</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="Fred Delrieu" class=" js-avatar" data-user="447849" height="24" src="https://avatars3.githubusercontent.com/u/447849?s=140" width="24" />
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/caouecs/Laravel4-lang/raw/master/ru/reminders.php" class="button minibutton " id="raw-url">Raw</a>
            <a href="/caouecs/Laravel4-lang/blame/master/ru/reminders.php" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/caouecs/Laravel4-lang/commits/master/ru/reminders.php" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L24" rel="#L24">24</span>
           ...
           <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="o">&lt;?</span><span class="nx">php</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="k">return</span> <span class="k">array</span><span class="p">(</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="cm">/*</span></div><div class='line' id='LC6'><span class="cm">    |--------------------------------------------------------------------------</span></div><div class='line' id='LC7'><span class="cm">    | Языковые ресурсы напоминания пароля</span></div><div class='line' id='LC8'><span class="cm">    |--------------------------------------------------------------------------</span></div><div class='line' id='LC9'><span class="cm">    |</span></div><div class='line' id='LC10'><span class="cm">    | Последующие языковые строки возвращаются брокером паролей на неудачные</span></div><div class='line' id='LC11'><span class="cm">    | попытки обновления пароля в таких случаях, как ошибочный код сброса</span></div><div class='line' id='LC12'><span class="cm">    | пароля или неверный новый пароль.</span></div><div class='line' id='LC13'><span class="cm">    |</span></div><div class='line' id='LC14'><span class="cm">    */</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;password&quot;</span> <span class="o">=&gt;</span> <span class="s2">&quot;Пароли должны быть длиной шесть символов и совпадать с подтверждением.&quot;</span><span class="p">,</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;user&quot;</span>     <span class="o">=&gt;</span> <span class="s2">&quot;Не удалось найти пользователя с указанным электронным адресом.&quot;</span><span class="p">,</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;token&quot;</span>    <span class="o">=&gt;</span> <span class="s2">&quot;Ошибочный код сброса пароля.&quot;</span><span class="p">,</span></div><div class='line' id='LC21'><br/></div><div class='line' id='LC22'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;sent&quot;</span>     <span class="o">=&gt;</span> <span class="s2">&quot;Напоминание пароля отправлено!&quot;</span><span class="p">,</span></div><div class='line' id='LC23'><br/></div><div class='line' id='LC24'><span class="p">);</span></div></pre></div></td>
         </tr>
       </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02918s from github-fe131-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
